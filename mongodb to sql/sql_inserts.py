...
# plaatst nested dictionary values in root dict
...
# voorkomt eventuele errors en plaatst nodige waardes in een lijst
...
def insert_products(products, sql_connection, inserts):
    products_columns = ['_id', 'name', 'doelgroep', 'brand', 'gender', 'category', 'sub_category', 'sub_sub_category',
                        'selling_price', 'availability']
